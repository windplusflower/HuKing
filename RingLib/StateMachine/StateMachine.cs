...
namespace RingLib.StateMachine {
    ...
    public class StateMachine : MonoBehaviour {
        ...
        private HashSet<Event> inStateEvents = new();
        private Dictionary<Type, string> globalTransitions = new();
        ...
        protected List<T> CheckInStateEvents<T>() where T : Event {
            return inStateEvents.Where(e => e.GetType() == typeof(T)).Cast<T>().ToList();
        }
